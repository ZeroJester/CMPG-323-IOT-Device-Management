...
namespace DeviceManagement_WebApp.Repository
{
    public class DeviceRepository
    {
        ...
        private SelectList x;
        private SelectList y;
        ...
        private IActionResult View(List<Device> devices)
        {
        ...
        public IActionResult Create()
        {
            ...
            x = new SelectList(_context.Category, "CategoryId", "CategoryName");
            return (IActionResult)x;
        }
        ...
        public async Task<IActionResult> Edit(Guid? id)
        {
            ...
            x = new SelectList(_context.Category, "CategoryId", "CategoryName", device.CategoryId);
            y = new SelectList(_context.Zone, "ZoneId", "ZoneName", device.ZoneId);
        ...
        private IActionResult View(Device device)
        {
            throw new NotImplementedException();
        }
